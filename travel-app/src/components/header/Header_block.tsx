...
import FadeRight from "../ui/animations/FadeRight";
...
const Header_block = (props: Props) => {
  ...
  return (
    <div>
      <FadeRight delay={.7}>
        <div className="absolute shadow left-1/2 -translate-x-1/2 -bottom-96 rounded-xl flex flex-col max-w-7xl w-full gap-y-6 mx-auto bg-white p-8 text-black">
